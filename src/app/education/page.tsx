...
export default function EducationPage() {
  const [selectedTopic, setSelectedTopic] = useState<EducationTopic>(
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="space-y-8">
        ...
        <div className="space-y-8">
          ...
          {selectedTopic === EducationTopic.PROTEIN_SOURCES && (
            <ProteinSourcesContent />
          )}
          {selectedTopic === EducationTopic.PRACTICAL_TIPS && (
...
function EducationCard({
  ...
  return (
    <Card
      variant="elevated"
      className="p-8 hover:scale-[1.01] transition-all duration-300 animate-fadeIn"
    >
  ...
  return (
    <div className="space-y-6">
      <EducationCard title="What is Protein Quality?">
        <p>
          Protein quality refers to how well a protein provides the essential
          amino acids your body needs. It&apos;s determined by two main factors:
        </p>
        <ul className="list-disc ml-6 mt-3 space-y-1">
          <li>
            <strong>Amino Acid Profile</strong>: Does it contain all essential
            amino acids?
          </li>
          <li>
            <strong>Digestibility</strong>: How well can your body absorb and
            use it?
          </li>
        </ul>
        <p className="mt-3">
      ...
      <EducationCard title="How to Use This App">
        <ol className="list-decimal ml-6 space-y-2">
          <li>
            <strong>Enter</strong> the protein amount from your food label
          </li>
          <li>
            <strong>Add</strong> Daily Value % if available (more accurate)
          </li>
          <li>
            <strong>Select</strong> your protein source from our database
          </li>
          <li>
            <strong>Calculate</strong> to see the quality-adjusted protein
            amount
          </li>
          <li>
            <strong>Review</strong> your history to track patterns
          </li>
        </ol>
        <p className="mt-3">
  ...
  return (
    <div className="space-y-6">
      <EducationCard title="What is DIAAS?">
        <p>
          <strong>Digestible Indispensable Amino Acid Score (DIAAS)</strong> is
          the gold standard for measuring protein quality, recommended by the
          FAO since 2013.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            ...
            <div className="text-orange-700 text-sm">
              High-quality with minor limitations
            </div>
          ...
          <div className="bg-red-50 p-4 rounded-lg">
            ...
            <div className="text-red-700 text-sm">
              Significant amino acid limitations
            </div>
    ...
    <div className="space-y-6">
      <EducationCard title="What is PDCAAS?">
        <p>
          ...
          was the previous gold standard for protein quality assessment
          (1989-2013).
        </p>
      ...
      <EducationCard title="When We Use PDCAAS">
        <p>
          This app uses PDCAAS as a fallback when DIAAS data isn&apos;t
          available. Many protein sources still only have PDCAAS scores in
          scientific literature.
        </p>
        <p className="mt-3">
          While less accurate than DIAAS, PDCAAS still provides valuable insight
          into protein quality and is widely used in nutrition labeling.
        </p>
      </EducationCard>
    </div>
  );
    ...
    <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-blue-700 text-sm mb-2">
              Typically score higher because they:
            </p>
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-gray-600 mb-2">
                  {source.category.charAt(0).toUpperCase() +
                    source.category.slice(1)}
                </p>
                {source.diaasScore && (
      ...
      <EducationCard title="Combining Plant Proteins">
        ...
        <p className="mt-3 text-sm text-gray-600">
          You don&apos;t need to combine at every meal - just throughout the
          day!
        </p>
      </EducationCard>
    </div>
    ...
    <div className="space-y-6">
      ...
      <EducationCard title="Daily Protein Needs">
        <div className="space-y-3">
          ...
          <div className="bg-green-50 p-3 rounded">
            <strong className="text-green-800">Active Individuals:</strong>
